const CELADON_TOWER_STAGES=[
  {
    ...
    drawer:{title:"Prize plan",text:"[[137]] is the only living-dex species that must come from this prize counter. Buy one now and breed a second after the National Pokédex for [[233]], which evolves by trading with an Up-Grade. FireRed’s [[123]] and LeafGreen’s [[127]] are optional guaranteed alternatives to catching them in the Safari Zone. Abra and Clefairy are already covered; wait for the Safari Zone rather than buying the three-copy Dratini family here."},
    tasks:[
